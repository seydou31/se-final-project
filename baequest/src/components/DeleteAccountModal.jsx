...
export default function DeleteAccountModal({isOpen, onClose, onOverlayClick, handleDeleteAccount}){
    return (
        ...
        >
            ...
            <button onClick={handleDeleteAccount} className="deleteaccount__delete-btn">Delete Account</button>
            <button onClick={onClose} className="deleteaccount__cancel-btn">Cancel</button>
        </ModalWrapper>
    )
}
